<%@ Page Title="" Language="C#" MasterPageFile="~/ProjektMaster.Master" AutoEventWireup="true" CodeBehind="ProjektAžuriranje.aspx.cs" Inherits="AII.ProjektAžuriranje" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
            ...
            <div class="col-md-5 box">
                <div class="boundaries">
                    ...
                    <asp:Label
                        ...
                        CssClass="label"
                        ForeColor="#EE6C4D"
                        runat="server" meta:resourcekey="lblErrorResource1" />
                </div>
            </div>
