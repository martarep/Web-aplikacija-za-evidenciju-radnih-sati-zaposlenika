<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IzvještajTima.aspx.cs" Inherits="AII.IzvještajTima" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<body class="body_s" >
  ...
  <span class="nav-item navbar_description">
      <asp:Label Text="Izvještaj tima" runat="server" meta:resourcekey="LabelResource1" /></span>
         
      <asp:HyperLink NavigateUrl="~/IzvještajTima.aspx" runat="server" CssClass=" navbar_item" meta:resourcekey="HyperLinkResource1" >
<i class='fas fa-file-alt'></i>  Pregled
      </asp:HyperLink>

           <asp:HyperLink NavigateUrl="GlavniIzbornik.aspx" runat="server" CssClass="navbar_item menu_it" meta:resourcekey="HyperLinkResource2" >
    ...
    <form id="form1" runat="server" class="form_size" >
         <div class="form-inline" runat="server">
               <div class="site_description">
                   ...
                   <asp:Label Text="Tim" runat="server" meta:resourcekey="LabelResource2" />
        <asp:DropDownList 
            ID="ddlTim" 
             ForeColor="#293241" 
            ...
            runat="server" 
            Width="300px" 
            AutoPostBack="True" meta:resourcekey="ddlTimResource1">
        </asp:DropDownList> 
               </div>
              <div class="mt-4 ml-5">
                  <asp:Label Text="Od:"
            ...
            runat="server" meta:resourcekey="TextBox1Resource1" />
             ...
             <div class="ml-5">  <asp:Button Text="Prikaži" class="btn_o ml-5" ForeColor="#293241" BackColor="#EE6C4D" BorderColor="#EE6C4D" ID="btnPrikazi" OnClick="BtnPrikazi_Click"  runat="server" meta:resourcekey="btnPrikaziResource1" />

                     <asp:Button id="export" data-export="export" Text="Izvezi"  CssClass="btn_o ml-5" ForeColor="#293241" BackColor="#EE6C4D" BorderColor="#EE6C4D" runat="server" meta:resourcekey="btnIzveziResource1" />
             </div>
          </div> 
            ...
            <div class="position_center table_custom">  
                <table>
                    <thead>
                        ...
                        <tr>  
                            <td class="table_label"> <asp:Label Text="Tim" runat="server"  />
                                </td>
                            <td class="table_header"> <asp:Label id="idTim" runat="server"  /> </td>
                        ...
                        <tr>
                            ...
                            <td class="table_header">
                                <asp:Label Text="Redovni radni sati" runat="server"  /></td>
                            <td class="table_header">
                                <asp:Label Text="Prekovremeni radni sati" runat="server"  /></td>
                            <td class="table_header">
                                <asp:Label Text="Ukupno sati" runat="server" /></td>
                          <td></td>
                            </tr>
