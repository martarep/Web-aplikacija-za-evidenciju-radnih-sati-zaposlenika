<%@ Page Title="" Language="C#" MasterPageFile="~/KlijentMaster.Master" AutoEventWireup="true" CodeBehind="KlijentAžuriranje.aspx.cs" Inherits="AII.KlijentAžuriranje" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form runat="server" class="form_size">
        ...
        <asp:Panel ID="pnlPopup2" class="popUp_background" runat="server" Style="display: none" meta:resourcekey="pnlPopup2Resource1">
            ...
            <div id="p_m" class="p_main position_center">
                <asp:Label ID="Label2" Text="Nije moguće ukloniti postojeći projekt" runat="server" meta:resourcekey="Label2Resource1" />
            </div>
            <div class="position_center pb-3">
                <div>
