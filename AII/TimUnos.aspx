<%@ Page Title="" Language="C#" MasterPageFile="~/TimMaster.Master" AutoEventWireup="true" CodeBehind="TimUnos.aspx.cs" Inherits="AII.TimUnos" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
        ...
        <div class="row position_center">
            ...
            <div class="col-md-5 box">
                <div class="boundaries">
                    ...
                    <asp:ListBox ID="lbDjelatnik" runat="server" ForeColor="#293241" Rows="6" CssClass="form-control label listbox flex-fill" BackColor="#E0FBFC" meta:resourcekey="lbDjelatnikResource1"></asp:ListBox>
